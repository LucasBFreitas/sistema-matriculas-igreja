...
async function confirmarRenovacao(e){
 ...
 function imprimirRelatorio(tipo='1'){if(isProfessor&&(!String(tipoRelatorio||'').startsWith('turma_')||!opcoesRelatorio.some(o=>o.value===tipoRelatorio)))return falhar('Professor só pode emitir relatórios das suas turmas.');
