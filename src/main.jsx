...
async function confirmarRenovacao(e){
 ...
 async function salvarChamada(e){
  ...
  if(error)return falhar(error.message)
  setChamada({})
  await atualizar('Lista de presença salva.')
 }
